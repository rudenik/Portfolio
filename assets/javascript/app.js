...
window.onload = function() {
    if (window.innerWidth <= 430){
        $(".social-links").empty();
        var iconArray = ["fab fa-linkedin", "fab fa-twitter", "fab fa-facebook-f", "fab fa-instagram", "far fa-envelope"];
        var linkArray = ["https://www.linkedin.com/in/simon-cain-9159341a/", "https://twitter.com/rudenik", "https://www.facebook.com/", "https://www.instagram.com/rudenik/", "mailto:simon.cain@mail.utoronto.ca?subject=What's up with Simon Cain"];
        var orderList = $("<ul>");
